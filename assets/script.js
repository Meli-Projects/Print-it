...
const bannerImg = document.querySelector(".banner-img"); //Sélection des images bannière
const bannerText = document.querySelector("#banner p"); //Sélection des textes bannière
...
arrowRight.addEventListener("click", function (e) {
  ...
  console.log(e.currentTarget === this); // Vérifie que l'élément cliqué est celui qui écoute l'événement (true)
    ...
    //Boucle infinie : si on est sur la dernière slide, on revient à la première
...
arrowLeft.addEventListener("click", function (e) {
  ...
  console.log(e.currentTarget === this);
	...
	// Boucle infinie : on recule d'une slide, et si on passe sous 0 on va à la dernière
	indexTable--;
